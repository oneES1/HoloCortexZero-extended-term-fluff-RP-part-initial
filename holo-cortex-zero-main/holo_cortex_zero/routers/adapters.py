...
from holo_cortex_zero.adapters import ADAPTER_DICT, loaded_adapters
...
async def get_adapters_list(_platform_admin: PlatformAdminPrincipal = Depends(get_current_active_platform_admin)) -> Ret:
    """获取所有适配器的基本信息列表"""
    try:
        adapters = []
