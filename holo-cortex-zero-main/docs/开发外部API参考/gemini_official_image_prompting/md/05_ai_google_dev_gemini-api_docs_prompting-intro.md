...
2. **Temperature:** The temperature controls the degree of randomness in token
   ...
   **Note:** When using Gemini 3 models, we strongly recommend keeping the
   `temperature` at its default value of 1.0. Changing the temperature
...
- **Current day accuracy:** Add the following clause to the developer
...
- **Knowledge cutoff accuracy:** Add the following clause to the developer
...
- **Grounding performance:** Add the following clause to the developer
